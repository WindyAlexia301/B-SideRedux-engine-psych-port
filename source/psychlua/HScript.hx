...
class HScript extends SScript
{
	...
	override function preset()
	{
		...
		// setSpecialObject no existe en SScript 4.0.1 (es de una version mas nueva de SScript/HScript).
		// Con set('game', PlayState.instance) de arriba ya se puede acceder a PlayState desde el hscript como "game.algo".
