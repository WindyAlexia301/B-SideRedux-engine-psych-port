...
class PlayState extends MusicBeatState
{
	...
	override public function update(elapsed:Float)
	{
		...
		iconP1.animation.curAnim.curFrame = (healthBar.percent < 20) ? 1 : (healthBar.percent > 80) ? 2 : 0; //1 = losing, 2 = winning, 0 = neutral
		iconP2.animation.curAnim.curFrame = (healthBar.percent < 20) ? 2 : (healthBar.percent > 80) ? 1 : 0; //1 = losing, 2 = winning, 0 = neutral
