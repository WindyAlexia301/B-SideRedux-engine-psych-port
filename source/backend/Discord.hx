...
class DiscordClient
{
	...
	private static var _defaultID:String = "1206281682467037234";
	public static var clientID(default, set):String = _defaultID;

	private static var _options:Dynamic = {
		details: "In the Menus",
		state: null,
		largeImageKey: 'https://i.ytimg.com/vi/FXyR-3Ro7NA/maxresdefault.jpg',
		largeImageText: "B-Side Redux Engine",
		smallImageKey : null,
		startTimestamp : null,
		endTimestamp : null
	};
